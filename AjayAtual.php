...
<body>
  ...
  <h4 ><span></span><i class="bi bi-music-note-beamed"></i>Last Playing</h4>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>Ajay - Atual</h1>
                <p>Ajay-Atul are a music composer duo from Maharashtra, India. They have shared thoughts about their work, including the importance of accuracy and <br> respect in religious music, and the need to perform live.</p> 
                <div class="top">
               <img src="image\Ajay-Atual.jpeg" style="width:120px; height:120px; border-radius:50%; border:4px solid gray; object-fit:cover;">
              </div>
        ...
        <div class="master_play">
            ...
            <img src="image/Ajay_Atual/man udhan .jpeg" alt="" id="poster_master_play">
            <h5 id="title">
                Man Udhan Varyache
                <div class="subtitle">Shankar Mahadevan,  Ajay - Atul</div>
            </h5> 
    ...
    <script src="AjayAtual.js"></script>
</body>
