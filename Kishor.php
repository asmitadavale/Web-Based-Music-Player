...
<body>
  ...
  <h4 ><span></span><i class="bi bi-music-note-beamed"></i>Last Playing</h4>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>Kishor Kumar</h1>
                <p>I am determined to get out of this futile rat race and live as i've always wanted to. <br> In my native Khandwa, tha land of my forefather. I oly wanted to sing.</p>
                <div class="top">
               <img src="image\Kishor-kumar.jpeg" style="width:120px; height:120px; border-radius:50%; border:4px solid gray; object-fit:cover;">
              </div>
            </div>
        ...
        <div class="master_play">
            ...
            <img src="image/Kishor_Img/Dekha_ek_khwab.jpeg" alt="" id="poster_master_play">
            <h5 id="title">
                Dekha Ek Khwaab
                <div class="subtitle">Kishor Kumar, Lata Mangeshkar, Amitabh Bachchan</div>
            </h5> 
