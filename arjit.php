...
<body>
  ...
  <h4 ><span></span><i class="bi bi-music-note-beamed"></i>Last Playing</h4>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>Arijit singh</h1>
                <p>I wanted to be someone who wanted to produce music, and here I am, <br>and I'm happy about it.</p>
                <div class="top">
               <img src="image\Arjit-Singh.jpeg" style="width:120px; height:120px; border-radius:50%; border:4px solid gray; object-fit:cover;">
              </div>
            </div>
        ...
        <div class="master_play">
            ...
            <img src="image/Arjit.Image/Agar_tum_sath)ho.jpeg" alt="" id="poster_master_play">
            <h5 id="title">
                Agar Tum Saath Ho
