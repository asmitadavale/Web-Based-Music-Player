  ...
  <h4 ><span></span><i class="bi bi-music-note-beamed"></i>Last Playing</h4>
        ...
        <div class="song_side">
            ...
            <div class="content">
                ...
                <p>To me, music is oxygen & I know that someday even if I can't sing, <br> I can always continue listening to it.</p> 
                <div class="top">
               <img src="image\Shreya Ghoshal.jpeg" style="width:120px; height:120px; border-radius:50%; border:4px solid gray; object-fit:cover;">
              </div>
            </div>
        ...
        <div class="master_play">
            ...
            <img src="image/Shreya/Bairi piya.jpeg" alt="" id="poster_master_play">
            <h5 id="title">
                Bairi Piya
                <div class="subtitle">Shreya Ghoshal</div>
            </h5> 
