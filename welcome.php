...
<body>
  ...
  <h4 ><span></span><i class="bi bi-music-note-beamed"></i>Last Playing</h4>
            ...
            <div class="menu_song" style=" margin-top:20px;">
                ...
                <li class="songItem">
                    <span>11</span>
                    <img src="image/SMG.jpg" alt="">
                    <h5>Steak My Girl<br><div class="Subtitle">One Direction</div></h5>
        ...
        <div class="song_side">
            ...
            <div class="content">
                ...
                <br>
                <h3>Music</h3>
                <p>Music is no different than opium. Music affects the human mind in a way that makes people think of nothing but music and sensual matters. <br>
                     Music is a treason to the country, a treason to our youth, and we should cut out all this music and replace it with something instructive.<br>
                     Beautiful music is the art of the prophets that can calm the agitations of the soul;  it is one of the most magnificent and delightful presents God has given us.</p> 
            </div>
            <div class="popular_song">
             ...
             <div class="popular_artists">
                ...
                <div class="item">
                   ...
                   <li>
                    <a href="Sonu.php"><img src="image\Sonu nigam.jpeg" alt=""></a>
                   </li>
        ...
        <div class="master_play">
            ...
            <img src="image/khoobsurat.jpeg" alt="" id="poster_master_play">
            <h5 id="title">
                Khoobsurat
                <div class="subtitle">Sachin-Jigar, Vishal Mishra</div>
            </h5> 
