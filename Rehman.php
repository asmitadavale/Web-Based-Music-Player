...
<body>
  ...
  <h4 ><span></span><i class="bi bi-music-note-beamed"></i>Last Playing</h4>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>A. R. Rehman</h1>
                <p> Your inner voice is the voice of divinity To hear it, <br> we need to be in solitude, even it crowded places. </p>
                <div class="top">
               <img src="image\A.R. Rehman.jpeg" style="width:120px; height:120px; border-radius:50%; border:4px solid gray; object-fit:cover;">
              </div>
            </div>
            ...
            <div class="popular_song">
             ...
             <div class="popular_artists">
                ...
                <div class="item">
                   ...
                   <li>
                    <img src="image\A.R. Rehman.jpeg" alt="">
                   </li>
        ...
        <div class="master_play">
            ...
            <img src="image/Rehman/ay-hairathe-guru.jpg" alt="" id="poster_master_play">
            <h5 id="title">
                Ay Hairathe
