...
<body>
  ...
  <h4 ><span></span><i class="bi bi-music-note-beamed"></i>Last Playing</h4>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>Papon</h1>
                <p>He is believes that it's important to connect with a song or person, <br> and that he doesn't choose projects based on what others are making. </p>
                <div class="top">
               <img src="image\Papon.jpeg" style="width:120px; height:120px; border-radius:50%; border:4px solid gray; object-fit:cover;">
              </div>
            </div>
        ...
        <div class="master_play">
            ...
            <img src="image/papon/Bulleya.jpeg" alt="" id="poster_master_play">
            <h5 id="title">
                Bulleya
