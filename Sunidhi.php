...
<body>
  ...
  <h4 ><span></span><i class="bi bi-music-note-beamed"></i>Last Playing</h4>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>Sunidhi Chauhan</h1>
                <p> I tries to take responsibility for my action before and after, <br> and that i uses bird's eye vision to identify the impact of my action. </p>
                <div class="top">
               <img src="image\Sunidhi-Chauhan.jpeg" style="width:120px; height:120px; border-radius:50%; border:4px solid gray; object-fit:cover;">
              </div>
            </div>
        ...
        <div class="master_play">
            ...
            <img src="image/Sunidhi/the disko song.jpeg" alt="" id="poster_master_play">
            <h5 id="title">
                The disco song
