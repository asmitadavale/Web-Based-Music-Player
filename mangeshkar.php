  ...
  <h4 ><span></span><i class="bi bi-music-note-beamed"></i>Last Playing</h4>
        ...
        <div class="song_side">
            ...
            <div class="content">
                ...
                <p> It was not really the external influencer that made m a singer, <br> Music was within me. I was full of it. </p>
                <div class="top">
               <img src="image\Lata-Mangeshkar.jpeg" style="width:120px; height:120px; border-radius:50%; border:4px solid gray; object-fit:cover;">
              </div>
            </div>
        ...
        <div class="master_play">
            ...
            <img src="image/Mangeshkar/yeh-kahan-aa-gaye-hum-silsila-500-500.jpg" alt="" id="poster_master_play">
            <h5 id="title">
                Yeh Kaha Aa Gaye Hum
                <div class="subtitle">Lata Mangeshkar, Kishor Kumar</div>
            </h5> 
    ...
    <script src="mangeshkar.js"></script>
</body>
